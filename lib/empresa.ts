...
export const empresa = {
  ...
  telefone: process.env.NEXT_PUBLIC_EMPRESA_TELEFONE ?? "(00) 0000-0000",
...
export const bancosParceiros = ["BRB Financeira", "Santander", "Digio", "Sicoob"] as const;

export const instagramUrl = `https://www.instagram.com/${empresa.instagram}`;
export const emailHref = `mailto:${empresa.email}`;
export const telefoneHref = `tel:+55${empresa.telefone.replace(/\D/g, "")}`;
